...
import com.example.waker.MainActivity;
...
//    private final String MODEL_YOLOV5S = "yolov5s-dynamic.tflite";
    ...
    private final String MODEL_HEADS = "head_yolov5s.tflite";
    ...
    public Yolov5TFLiteDetector(Context activity, String modelFile) {
        setModelFile(modelFile);
        addGPUDelegate();
        initialModel(activity);
        Log.i("tfliteSupport", "Model loaded.");
    };
